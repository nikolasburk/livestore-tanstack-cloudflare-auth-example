/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 596206e8c86a7d4687e55ad791e66ebb)
// Runtime types generated with workerd@1.20251109.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "SyncBackendDO";
	}
	interface Env {
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		SYNC_BACKEND_DO: DurableObjectNamespace<import("./src/server").SyncBackendDO>;
		auth_db: D1Database;
	}
}
